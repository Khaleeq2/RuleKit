...
| `tests/smoke.spec.ts` | 13 smoke tests across 4 test groups |
...
| Criterion | Evidence |
|-----------|----------|
| A repeatable automated smoke suite exists and passes | `tests/smoke.spec.ts` with 13 tests, runnable via `npm test` |
